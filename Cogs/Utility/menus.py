...
class PollButton(disnake.ui.Button):
    ...
    async def callback(self, interaction: disnake.Interaction):
        ...
        await self.view.message.edit(f"{newmessage}", allowed_mentions = disnake.AllowedMentions.none())
...
class PollMenu(disnake.ui.View):
    ...
    async def endpoll(self):
        ...
        await self.message.edit(f"{newmessage}", view = self, allowed_mentions = disnake.AllowedMentions.none())
