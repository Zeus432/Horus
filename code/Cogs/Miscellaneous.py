...
class Misc(commands.Cog):
    ...
    async def info(self, ctx):
        ...
        emb.add_field(name="About Horus:",value=f"Horus is a private bot made for fun, has simple moderation, fun commands. For bot support join the support server by clicking the button below\n\u200b",inline = False)
